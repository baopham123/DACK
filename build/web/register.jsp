		...
		<div class="container">
			...
			<div class="col-md-6 login-do1 animated wow fadeInLeft" data-wow-delay=".5s">
				...
				<label class="hvr-sweep-to-top login-sub">
                        ...
                        <div style="margin-left: 15px;float: left;margin-top: 10px;">
			...
			<div class="clearfix"> </div>
                        ...
                        <div class="col-md-6 login-do1 animated wow fadeInLeft" data-wow-delay=".5s">
                            <img src="images/imglogin.jpg" width="540px;" height="460px;" alt="alt"/>
                        </div>
			</form>
		</div>
	</div>
        <div class="social animated wow fadeInUp" data-wow-delay=".1s"></div>
